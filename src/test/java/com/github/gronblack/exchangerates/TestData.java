...
public final class TestData {
    ...
    public static final String GIF_URL_POSITIVE = "positive-gif-url";
    public static final String GIF_URL_NEGATIVE = "negative-gif-url";

    public static final Gif GIF_POSITIVE = new Gif(Map.of("embed_url", GIF_URL_POSITIVE), Map.of("status", 200));
    public static final Gif GIF_NEGATIVE = new Gif(Map.of("embed_url", GIF_URL_NEGATIVE), Map.of("status", 200));
